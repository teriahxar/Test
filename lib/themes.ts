...
export const THEME_PACKS: Record<string, ThemePack> = {
  ...
  pop: {
    ...
    primaryForeground: "0 0% 100%",
    secondary: "169 44% 88%",
    secondaryForeground: "213 31% 24%",
    accent: "33 89% 81%",
    accentForeground: "213 31% 24%",
    background: "198 66% 97%",
    foreground: "214 36% 19%",
    muted: "188 42% 91%",
    mutedForeground: "214 18% 38%",
    card: "0 0% 100%",
    cardForeground: "214 36% 19%",
    border: "195 38% 84%",
    input: "194 34% 88%",
    ring: "145 38% 44%",
    destructive: "0 72% 58%",
    destructiveForeground: "0 0% 98%",
    radius: "28px",
    shadowCard: "0 16px 40px rgba(58, 114, 82, 0.15)",
    shadowGlow: "0 12px 28px rgba(251, 209, 160, 0.22)",
    bgStyle:
      "radial-gradient(circle at 12% 16%, rgba(168, 214, 255, 0.34), transparent 23%), radial-gradient(circle at 82% 12%, rgba(255, 238, 164, 0.36), transparent 21%), radial-gradient(circle at 82% 74%, rgba(184, 236, 203, 0.34), transparent 22%), linear-gradient(180deg, rgba(247,252,255,0.98), rgba(240,249,252,0.97))",
    buttonStyle: "soft",
    fontDisplayClass: "font-display",
    fontBodyClass: "font-body",
    stickerSet: "moonpetal",
    patternClass: "theme-clouds",
    chartStroke: "hsl(145 38% 44%)",
    chartGrid: "rgba(71, 126, 92, 0.15)"
  },
  neutral: {
    id: "TRINKET_NEUTRAL",
    label: "Neutral",
    ...
    destructiveForeground: "0 0% 98%",
    radius: "26px",
    shadowCard: "0 16px 36px rgba(57, 99, 73, 0.14)",
    shadowGlow: "0 10px 24px rgba(251, 209, 160, 0.22)",
    bgStyle:
    ...
    stickerSet: "woodland",
    patternClass: "theme-clouds",
    chartStroke: "hsl(145 36% 43%)",
    chartGrid: "rgba(71, 124, 93, 0.14)"
  }
};
