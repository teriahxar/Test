...
export function CollectionClient() {
  ...
  return (
    <div className="space-y-6">
      ...
      <section className="panel-card rounded-[20px] p-6">
        ...
        <div className="mt-5 grid gap-4">
          {entries.map((entry) => (
            <Link
              ...
              className="panel-card grid gap-4 rounded-[20px] p-4 transition hover:-translate-y-0.5 md:grid-cols-[auto_1fr_auto_auto] md:items-center"
            >
              <div className="panel-frame relative h-20 w-20 overflow-hidden">
                <ItemImageFallback src={entry.imageUrl} alt={entry.name} fill className="h-full w-full object-cover" />
              </div>
              <div>
